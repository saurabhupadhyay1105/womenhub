(function($) {
    ...
    Quiz.prototype.render = function(container) {
      ...
      //      $('#timer-box').hide();
        ...
        //    console.log(percentage);
            ...
            $('.score-label h1').html('Your Score');
        ...
        // Add listener for the end test button
    ...
    Question.prototype.render = function(container) {
        ...
        if (container.children('h2').length === 0) {
            question_string_h2 = $('<h2>').attr('id','ques').appendTo(container);
        } else {
            question_string_h2 = container.children('h2').first();
        }
        question_string_h2.text(this.question_string);
        document.querySelector('h2').innerHTML=this.question_string;
    ...
    $(document).ready(function() {
       ...
       function useApiData(data){
        for (var i = 0; i < data.results.length; i++) {
            var question = new Question((i + 1), data.results[i].question, data.results[i].correct_answer, data.results[i].incorrect_answers);
        //     console.log(data.results[i].question);
            // Add the question to the instance of the Quiz object that we created previously
            quiz.add_question(question);
        }
        //document.getElementById("totalques").innerText = data.results.length + " Questions";
    }
        // Render the quiz
